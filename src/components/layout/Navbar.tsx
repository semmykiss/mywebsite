          ...
          <div className="flex items-center justify-between h-20 lg:h-32">
            ...
            <Link href="/" className="flex items-center gap-2.5 group flex-shrink-0">
              ...
              <div className="flex flex-col leading-tight">
                ...
                <span className="label-mono text-[#0078D4]">
                  Systems
                </span>
              </div>
            </Link>
                ...
                link.hasDropdown ? (
                  <div key={link.label} className="relative">
                    <button
                      ...
                      className={cn(
                        "flex items-center gap-1 px-4 py-2 rounded-full text-sm font-medium text-[#444444] hover:bg-[#f3f3f3] transition-colors duration-150",
                        servicesOpen && "bg-[#f3f3f3] text-[#0078D4]"
                      )}
                    >
                      {link.label}
                    ...
                    <AnimatePresence>
                      {servicesOpen && (
                        <motion.div
                          ...
                          className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-[1040px] card-flat overflow-hidden"
                        >
                          <div className="p-2">
                            <div className="grid grid-cols-5 gap-0">
                              {services.map((cat) => (
                                <div key={cat.category} className="p-4">
                                  <p className="label-mono text-[#0078D4] mb-3">
                                    {cat.category}
                                  </p>
                                  <div className="space-y-1">
                                    {cat.items.map((item) => (
                                      <Link
                                        ...
                                        className="flex items-start gap-2.5 p-2 rounded-xl hover:bg-[#f3f3f3] group/item transition-colors"
                                      >
                                        <div className="w-7 h-7 rounded-lg bg-[#f3f3f3] flex items-center justify-center flex-shrink-0 group-hover/item:bg-[#0F172A] transition-colors mt-0.5">
                                          <item.icon className="w-3.5 h-3.5 text-[#0078D4] group-hover/item:text-white transition-colors" />
                                        </div>
                                        <div>
                                          <p className="text-sm font-medium text-[#0F172A] group-hover/item:text-[#0078D4] transition-colors leading-tight">
                                            {item.name}
                                          </p>
                                          <p className="text-[11px] text-[#979797] mt-0.5 leading-tight">{item.desc}</p>
                                        </div>
                                      </Link>
                                    ))}
                                  </div>
                            ...
                            <div className="mx-4 mb-3 mt-1 p-3 rounded-xl bg-[#0F172A] flex items-center justify-between">
                              <div>
                                <p className="text-white font-semibold text-sm">Need a custom solution?</p>
                                <p className="text-white/60 text-xs mt-0.5">Talk to our experts about your requirements</p>
                              </div>
                              <Link
                                href="/contact"
                                onClick={() => setServicesOpen(false)}
                                className="px-4 py-2 bg-white text-[#0F172A] rounded-lg text-sm font-semibold hover:bg-[#f3f3f3] transition-colors flex-shrink-0"
                              >
                                Book Consultation
                              </Link>
                            </div>
                  ...
                  <Link
                    key={link.label}
                    href={link.href}
                    className="px-4 py-2 rounded-full text-sm font-medium text-[#444444] hover:bg-[#f3f3f3] transition-colors duration-150"
                  >
                    {link.label}
                  </Link>
                )
            ...
            <div className="hidden lg:flex items-center gap-4">
              <Link
                ...
                className={cn(
                  ...
                  isScrolled ? "text-[#444444] hover:text-[#0078D4]" : "text-white/80 hover:text-white"
                )}
              >
        ...
        {mobileOpen && (
          <>
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 bg-[#0F172A]/60 z-40 lg:hidden"
            ...
            >
              <div className="flex items-center justify-between p-5 border-b">
                <Link href="/" onClick={() => setMobileOpen(false)} className="flex items-center gap-2">
                    <Image
                      ...
                      className="w-full h-full object-contain"
                    />
                  <span className="font-bold text-[#0F172A]">Pentacore Systems</span>
                </Link>
                <button onClick={() => setMobileOpen(false)} className="p-1.5 rounded-lg hover:bg-[#f3f3f3]">
                  ...
                  link.hasDropdown ? (
                    <div key={link.label}>
                      <button
                        ...
                        className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-[#444444] font-medium hover:bg-[#f3f3f3] hover:text-[#0078D4] transition-colors"
                      >
                        {link.label}
                            ...
                            <div className="mt-1 ml-3 space-y-3 pb-2">
                              {services.map((cat) => (
                                <div key={cat.category}>
                                  <p className="label-mono text-[#0078D4] px-3 py-1">
                                    {cat.category}
                                  </p>
                                  {cat.items.map((item) => (
                                    <Link
                                      ...
                                      href={item.href}
                                      onClick={() => setMobileOpen(false)}
                                      className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-[#444444] hover:text-[#0078D4] hover:bg-[#f3f3f3] transition-colors"
                                    >
                                      <item.icon className="w-4 h-4 text-[#0078D4] flex-shrink-0" />
                                      {item.name}
                                    </Link>
                                  ))}
                                </div>
                    ...
                    <Link
                      ...
                      href={link.href}
                      onClick={() => setMobileOpen(false)}
                      className="block px-3 py-2.5 rounded-xl text-[#444444] font-medium hover:bg-[#f3f3f3] hover:text-[#0078D4] transition-colors"
                    >
                      {link.label}
                    </Link>
                  )
              ...
              <div className="p-4 border-t border-[#c6c6c6] space-y-3">
                <a
                  href="tel:+1234567890"
                  className="flex items-center gap-2 px-3 py-2.5 text-[#444444] hover:text-[#0078D4] transition-colors"
                >
